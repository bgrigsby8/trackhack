...
''';
    ...
    test('parseProjectsFromCsv correctly parses completed and in-progress projects', () async {
      final projects = await CsvImportUtil.parseProjectsFromCsv(tempFile, testUserId);
